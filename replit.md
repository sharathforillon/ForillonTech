...
- **November 04, 2025**: Removed non-functional Netlify CMS admin - use `/admin` for the working admin dashboard instead
...
- **October 28, 2025**: Clean, intuitive UX: select features first, then fill form to request demo
