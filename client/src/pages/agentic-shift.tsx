...
function useSeats() {
  ...
  useEffect(() => {
    ...
    // Re-poll every 60 seconds so counter stays fresh without a refresh
...
function RegistrationModal({ tier, onClose }: RegModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // non-blocking — proceed to Stripe even if save fails
    }
    // If real Stripe URL: navigate away. If placeholder (#…): close modal gracefully.
  ...
  return (
    <div style={{
      ...
      <div style={{
        background: C.white, borderRadius: 14, width: "100%", maxWidth: 460,
        boxShadow: "0 24px 80px rgba(13,27,42,0.25)",
        position: "relative", overflow: "visible",
      }} onClick={e => e.stopPropagation()}>
        {/* Gold top bar */}
        <div style={{ height: 4, background: `linear-gradient(90deg, ${C.gold} 0%, ${C.goldLight} 100%)`, borderRadius: "14px 14px 0 0" }} />

        <div style={{ padding: "32px 32px 28px" }}>
          {/* Close */}
          <button onClick={onClose} style={{ position: "absolute", top: 16, right: 16, background: "none", border: "none", cursor: "pointer", color: C.textMuted, padding: 4 }}>
          ...
          <div style={{ marginBottom: 24 }}>
            ...
            <h3 style={{ fontFamily: serif, fontSize: 24, fontWeight: 700, color: C.navy, margin: "0 0 4px" }}>
              Reserve your seat
            </h3>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            {/* Country — drives dial code auto-fill */}
            <div>
            ...
            {/* Phone with searchable dial-code picker */}
            <div>
              ...
              <div style={{ display: "flex", gap: 6, position: "relative" }} ref={codeDropRef}>
                ...
                <button type="button"
                  ...
                  style={{
                    flexShrink: 0, minWidth: 80, padding: "11px 10px",
                ...
                {showCodeDrop && (
                  <div style={{
                    ...
                    width: 260, boxShadow: "0 12px 32px rgba(13,27,42,0.15)",
                    ...
                    <div style={{ padding: "8px 10px", borderBottom: `1px solid ${C.border}`, background: C.cream }}>
                      <input
                        ...
                        style={{
                          ...
                          background: C.white, boxSizing: "border-box", color: C.text,
                        }}
                      />
                    </div>
                    {/* Results list */}
                        ...
                        : filteredCodes.map(c => (
                          <button key={`${c.code}-${c.name}`} type="button"
                            ...
                            style={{
                              ...
                              background: dialCode === c.code ? C.warmLight : "transparent",
...
export default function AgenticShiftPage({ tier = "executive" }: AgenticShiftPageProps) {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => { setNavBg(window.scrollY > 60); setShowBar(window.scrollY > 800); };
  ...
  return (
    <div style={{ background: C.cream, fontFamily: sans, color: C.text }}>
      {showModal && <RegistrationModal tier={tier} onClose={() => setShowModal(false)} />}
      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <a href="/" style={{ textDecoration: "none" }}>
            <span style={{ fontFamily: serif, fontSize: 20, fontWeight: 700, color: navBg ? C.navy : C.white, letterSpacing: "-0.02em" }}>
              Forillon<span style={{ color: C.goldLight }}>Tech</span>
            </span>
          </a>
          <div style={{ display: "flex", alignItems: "center", gap: 32 }}>
            {["The Session", "Framework", "Pricing"].map(l => (
            ...
            <button onClick={openReg} style={{ background: C.gold, color: C.white, border: "none", cursor: "pointer", fontSize: 13, fontFamily: sans, fontWeight: 600, padding: "10px 22px", borderRadius: 6 }}>
              Reserve Your Seat
            </button>
          </div>
        </div>
      ...
      {/* ── HERO ──────────────────────────────────────────── */}
      <section style={{ background: C.navy, minHeight: "100vh", display: "flex", alignItems: "center", paddingTop: 64, position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "96px 24px", width: "100%", position: "relative", zIndex: 1 }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 400px", gap: 80, alignItems: "center" }}>

            {/* Left */}
            <div>
              <div style={{ display: "inline-flex", alignItems: "center", gap: 8, marginBottom: 32, padding: "6px 14px", border: `1px solid rgba(184,151,43,0.4)`, borderRadius: 4 }}>
              ...
              <h1 style={{ fontFamily: serif, fontSize: "clamp(64px,8vw,96px)", fontWeight: 700, lineHeight: 1.0, letterSpacing: "-0.02em", color: C.white, margin: "0 0 28px" }}>
                The<br /><span style={{ color: C.goldLight }}>Agentic</span><br />Shift
              </h1>

              <p style={{ fontSize: 20, color: "rgba(255,255,255,0.65)", fontWeight: 400, lineHeight: 1.5, margin: "0 0 16px", maxWidth: 520 }}>
                The blueprint every MENA executive needs to move AI from pilot to P&L.
              </p>
              <p style={{ fontSize: 16, color: "rgba(255,255,255,0.45)", lineHeight: 1.7, margin: "0 0 40px", maxWidth: 500 }}>
              ...
              <div style={{ display: "flex", gap: 14, flexWrap: "wrap", alignItems: "center" }}>
                <button onClick={openReg} style={{ background: C.goldLight, color: C.white, border: "none", cursor: "pointer", fontSize: 15, fontFamily: sans, fontWeight: 600, padding: "14px 32px", borderRadius: 6, display: "flex", alignItems: "center", gap: 8 }}>
            ...
            {/* Right: Session card */}
            <div style={{ background: C.cream, borderRadius: 12, padding: 32 }}>
              <p style={{ fontSize: 11, fontFamily: sans, fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", color: C.textMuted, marginBottom: 14 }}>Session opens in</p>
              <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 8, marginBottom: 28 }}>
                {[{ l: "Days", v: countdown.days }, { l: "Hrs", v: countdown.hours }, { l: "Min", v: countdown.minutes }, { l: "Sec", v: countdown.seconds }].map(({ l, v }) => (
                  <div key={l} style={{ textAlign: "center", padding: "12px 6px", border: `1px solid ${C.border}`, borderRadius: 6, background: C.white }}>
                    <div style={{ fontFamily: sans, fontSize: 26, fontWeight: 700, color: C.navy, lineHeight: 1 }}>{String(v).padStart(2, "0")}</div>
                    <div style={{ fontSize: 10, color: C.textMuted, marginTop: 4, fontWeight: 500, letterSpacing: "0.05em" }}>{l}</div>
                  </div>
                ))}
              </div>

              <div style={{ display: "flex", flexDirection: "column", gap: 16, paddingTop: 20, borderTop: `1px solid ${C.border}`, marginBottom: 20 }}>
                {[
                  ...
                  <div key={label} style={{ display: "flex", alignItems: "center", gap: 12 }}>
                    <div style={{ width: 32, height: 32, borderRadius: 6, background: C.warmLight, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                      <Icon style={{ width: 15, height: 15, color: C.navy }} />
                    </div>
                    <div>
                      <div style={{ fontSize: 10, color: C.textMuted, fontWeight: 600, letterSpacing: "0.06em", textTransform: "uppercase" }}>{label}</div>
                      <div style={{ fontSize: 14, fontWeight: 600, color: C.text, marginTop: 1 }}>{val}</div>
                    </div>
                  </div>
                ))}
              </div>

              <div style={{ background: C.warmLight, borderRadius: 8, padding: "12px 14px", marginBottom: 18 }}>
      ...
      <div style={{ background: C.white, borderBottom: `1px solid ${C.border}`, padding: "20px 24px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", flexWrap: "wrap", gap: "16px 48px", alignItems: "center", justifyContent: "center" }}>
          {[
            { label: "IBM Inventor",            sub: "12 Years Enterprise AI" },
            { label: "USPTO Patent 11,509,770", sub: "Human-Bot Orchestration Layer" },
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div ref={s1.ref} style={{ opacity: s1.v ? 1 : 0, transform: s1.v ? "none" : "translateY(24px)", transition: "all 0.8s ease" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 56 }}>
              ...
              <span style={{ fontSize: 11, fontWeight: 600, letterSpacing: "0.12em", textTransform: "uppercase", color: C.textMuted, whiteSpace: "nowrap" }}>The State of Enterprise AI · 2026</span>
              <div style={{ height: 1, flex: 1, background: C.border }} />
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, marginBottom: 72, alignItems: "start" }}>
              <div>
                <h2 style={{ fontFamily: serif, fontSize: "clamp(36px,4vw,52px)", fontWeight: 700, lineHeight: 1.15, letterSpacing: "-0.02em", color: C.navy, margin: "0 0 24px" }}>
                  Your board is asking about agents. Your team is still running pilots that go nowhere.
                </h2>
                <p style={{ fontSize: 17, color: C.textSecond, lineHeight: 1.7, margin: 0 }}>These numbers never appear in the keynotes. They are the entire reason this session was built.</p>
              </div>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
                {[
                  { stat: "95%",   label: "Enterprise GenAI pilots deliver zero P&L impact",             source: "MIT NANDA" },
                  { stat: "30%",   label: "GenAI projects to be abandoned due to data quality issues, cost overruns, and no ROI", source: "Gartner" },
                  ...
                  <div key={stat} style={{ paddingTop: 20, borderTop: `3px solid ${C.gold}` }}>
                    <div style={{ fontFamily: serif, fontSize: 44, fontWeight: 700, color: C.navy, lineHeight: 1, marginBottom: 8 }}>{stat}</div>
                    <p style={{ fontSize: 13, color: C.textSecond, lineHeight: 1.5, margin: "0 0 8px" }}>{label}</p>
                    <p style={{ fontSize: 11, color: C.textMuted, fontWeight: 600, letterSpacing: "0.06em", textTransform: "uppercase" }}>{source}</p>
                  </div>
                ))}
              </div>
            </div>
            <div style={{ background: C.white, borderRadius: 10, padding: 40, border: `1px solid ${C.border}` }}>
              <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: C.textMuted, marginBottom: 28 }}>What MENA leaders are saying. Behind closed doors.</p>
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 32 }}>
                {[
                  ...
                  <div key={i} style={{ paddingLeft: 20, borderLeft: `3px solid ${C.goldLight}` }}>
                    <p style={{ fontSize: 15, fontFamily: serif, fontStyle: "italic", color: C.navy, lineHeight: 1.6, margin: "0 0 12px" }}>{p}</p>
                    <span style={{ fontSize: 11, fontWeight: 600, color: C.textMuted, letterSpacing: "0.06em" }}>MENA executive, 2025</span>
                  </div>
                ))}
              </div>
              <p style={{ fontSize: 14, color: C.textSecond, marginTop: 28, paddingTop: 24, borderTop: `1px solid ${C.border}` }}>
      ...
      <section style={{ background: C.white, padding: "96px 24px", borderTop: `1px solid ${C.border}` }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div ref={s2.ref} style={{ opacity: s2.v ? 1 : 0, transform: s2.v ? "none" : "translateY(24px)", transition: "all 0.8s ease" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 56 }}>
              <div style={{ height: 1, flex: 1, background: C.border }} />
              <span style={{ fontSize: 11, fontWeight: 600, letterSpacing: "0.12em", textTransform: "uppercase", color: C.textMuted, whiteSpace: "nowrap" }}>Act II · The Four Traps</span>
              <div style={{ height: 1, flex: 1, background: C.border }} />
            </div>
            <div style={{ marginBottom: 48 }}>
              <h2 style={{ fontFamily: serif, fontSize: "clamp(36px,4vw,52px)", fontWeight: 700, lineHeight: 1.15, letterSpacing: "-0.02em", color: C.navy, margin: "0 0 16px" }}>
                Over $1 billion in losses.<br />Four traps. Every single one preventable.
              </h2>
              <p style={{ fontSize: 17, color: C.textSecond, lineHeight: 1.6, maxWidth: 600, margin: 0 }}>Real companies. Real consequences. These exact patterns are playing out in MENA boardrooms right now.</p>
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
              {TRAPS.map(t => (
                <div key={t.n} style={{ padding: 32, background: C.cream, borderRadius: 10, borderLeft: `4px solid ${C.gold}`, border: `1px solid ${C.border}`, borderLeftWidth: 4, borderLeftColor: C.gold }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 16 }}>
                    <div>
                      <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: C.goldLight, marginBottom: 6 }}>Trap {t.n}</div>
                      <h3 style={{ fontFamily: serif, fontSize: 22, fontWeight: 700, color: C.navy, margin: 0, lineHeight: 1.2 }}>{t.title}</h3>
                    </div>
                    <div style={{ textAlign: "right", flexShrink: 0, marginLeft: 16 }}>
                      <div style={{ fontSize: 11, color: C.textMuted, marginBottom: 2 }}>Loss</div>
                      <div style={{ fontSize: 14, fontWeight: 700, color: "#B91C1C" }}>{t.loss}</div>
                    </div>
                  </div>
                  <p style={{ fontSize: 14, fontFamily: serif, fontStyle: "italic", color: C.textSecond, margin: "0 0 16px", lineHeight: 1.6 }}>"{t.quote}"</p>
                  <div style={{ background: C.white, borderRadius: 6, padding: "14px 16px", marginBottom: 16 }}>
                    <div style={{ fontSize: 11, fontWeight: 600, color: C.textMuted, letterSpacing: "0.06em", textTransform: "uppercase", marginBottom: 8 }}>{t.co}</div>
                    <p style={{ fontSize: 14, color: C.textSecond, lineHeight: 1.6, margin: 0 }}>{t.story}</p>
                  </div>
                  <div style={{ display: "flex", alignItems: "flex-start", gap: 8 }}>
                    <span style={{ fontSize: 11, fontWeight: 700, color: C.gold, flexShrink: 0, marginTop: 1 }}>DIAGNOSTIC</span>
      ...
      {/* ── THE FRAMEWORK ─────────────────────────────────── */}
      <section style={{ background: C.cream, padding: "96px 24px", borderTop: `1px solid ${C.border}` }} id="framework">
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div ref={s3.ref} style={{ opacity: s3.v ? 1 : 0, transform: s3.v ? "none" : "translateY(24px)", transition: "all 0.8s ease" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 56 }}>
              <div style={{ height: 1, flex: 1, background: C.border }} />
              <span style={{ fontSize: 11, fontWeight: 600, letterSpacing: "0.12em", textTransform: "uppercase", color: C.textMuted, whiteSpace: "nowrap" }}>Proprietary IP · Two USPTO Patents</span>
              <div style={{ height: 1, flex: 1, background: C.border }} />
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "start" }}>
              <div>
                ...
                <p style={{ fontSize: 16, color: C.textSecond, lineHeight: 1.7, marginBottom: 24 }}>
                ...
                <p style={{ fontSize: 16, color: C.textSecond, lineHeight: 1.7, marginBottom: 32 }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                  {[
                    ...
                    <a key={num} href="https://patents.google.com/?inventor=%22Sharath+Kancharla%22&oq=inventor:+%22Sharath+Kancharla%22"
                      ...
                      style={{ display: "flex", alignItems: "center", gap: 12, padding: "14px 18px", background: C.white, borderRadius: 8, border: `1px solid ${C.border}`, textDecoration: "none" }}>
                      <Award style={{ width: 18, height: 18, color: C.gold, flexShrink: 0 }} />
                      <div style={{ flex: 1 }}>
                        <div style={{ fontSize: 13, fontWeight: 700, color: C.navy }}>{num}</div>
                        <div style={{ fontSize: 12, color: C.textMuted, marginTop: 1 }}>{label}</div>
                      </div>
                      <ExternalLink style={{ width: 13, height: 13, color: C.textMuted, flexShrink: 0 }} />
                    </a>
                  ))}
                </div>
              </div>
              <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
                {PILLARS.map(({ icon: Icon, n, title, q, patent, case: cs }) => (
                  <div key={n} style={{ padding: "24px 0", borderBottom: `1px solid ${C.border}`, display: "flex", gap: 20, alignItems: "flex-start" }}>
                    <div style={{ width: 40, height: 40, borderRadius: 6, background: patent ? C.navy : C.warmLight, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                      <Icon style={{ width: 18, height: 18, color: patent ? C.goldLight : C.navy }} />
                    </div>
                    <div style={{ flex: 1 }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 4, flexWrap: "wrap" }}>
                        <span style={{ fontSize: 11, fontWeight: 700, color: C.textMuted }}>{n}</span>
                        <span style={{ fontSize: 15, fontWeight: 700, color: C.navy }}>{title}</span>
                        {patent && <span style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.08em", padding: "2px 8px", background: C.goldPale, color: C.gold, borderRadius: 4, textTransform: "uppercase" }}>Patent IP</span>}
                      </div>
                      <p style={{ fontSize: 13, fontStyle: "italic", color: C.textSecond, margin: "0 0 8px", lineHeight: 1.5 }}>{q}</p>
      ...
      <section style={{ background: C.white, padding: "96px 24px", borderTop: `1px solid ${C.border}` }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div ref={s4.ref} style={{ opacity: s4.v ? 1 : 0, transform: s4.v ? "none" : "translateY(24px)", transition: "all 0.8s ease" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 56 }}>
              <div style={{ height: 1, flex: 1, background: C.border }} />
              <span style={{ fontSize: 11, fontWeight: 600, letterSpacing: "0.12em", textTransform: "uppercase", color: C.textMuted, whiteSpace: "nowrap" }}>The Overdeliver Kit · 24 Hours After the Session</span>
              <div style={{ height: 1, flex: 1, background: C.border }} />
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, marginBottom: 56, alignItems: "start" }}>
              <div>
                <h2 style={{ fontFamily: serif, fontSize: "clamp(32px,4vw,48px)", fontWeight: 700, lineHeight: 1.15, letterSpacing: "-0.02em", color: C.navy, margin: "0 0 16px" }}>You do not leave with ideas. You leave with 10 professional artifacts.</h2>
                <p style={{ fontSize: 17, color: C.textSecond, lineHeight: 1.6, margin: 0 }}>Not a certificate. Not a recording. A complete implementation kit. The tools that turn insight into an executable plan by Monday morning.</p>
              </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: 0 }}>
              {ARTIFACTS.map(({ icon: Icon, n, title, desc }, i) => (
                <div key={n} style={{ display: "flex", gap: 16, padding: "20px 24px", borderBottom: `1px solid ${C.border}`, borderRight: i % 2 === 0 ? `1px solid ${C.border}` : "none" }}>
                  <div><span style={{ fontFamily: serif, fontSize: 28, fontWeight: 700, color: C.border, display: "block", lineHeight: 1, marginBottom: 12 }}>{n}</span></div>
                  <div>
                    <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
                      <Icon style={{ width: 14, height: 14, color: C.gold, flexShrink: 0 }} />
      ...
      {/* ── SPEAKER ───────────────────────────────────────── */}
      <section style={{ background: C.cream, padding: "96px 24px", borderTop: `1px solid ${C.border}` }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div ref={s5.ref} style={{ opacity: s5.v ? 1 : 0, transform: s5.v ? "none" : "translateY(24px)", transition: "all 0.8s ease" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 56 }}>
              <div style={{ height: 1, flex: 1, background: C.border }} />
              <span style={{ fontSize: 11, fontWeight: 600, letterSpacing: "0.12em", textTransform: "uppercase", color: C.textMuted, whiteSpace: "nowrap" }}>Your Speaker</span>
              <div style={{ height: 1, flex: 1, background: C.border }} />
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "300px 1fr", gap: 80, alignItems: "start" }}>
              <div>
                <div style={{ width: 72, height: 72, borderRadius: 10, background: C.navy, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 20 }}>
                  <span style={{ fontFamily: serif, fontSize: 24, fontWeight: 700, color: C.goldLight }}>SK</span>
                </div>
                <h3 style={{ fontFamily: serif, fontSize: 26, fontWeight: 700, color: C.navy, margin: "0 0 4px", lineHeight: 1.2 }}>Sharath Kancharla</h3>
                <p style={{ fontSize: 14, color: C.gold, fontWeight: 600, margin: "0 0 20px" }}>IBM Inventor · USPTO Patent Holder</p>
                <p style={{ fontSize: 13, color: C.textMuted, margin: "0 0 24px" }}>Dubai, UAE</p>
              ...
              <div>
                <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
                  {[
                    ...
                    <div key={label} style={{ display: "grid", gridTemplateColumns: "120px 1fr", gap: 24, padding: "20px 0", borderBottom: `1px solid ${C.border}` }}>
                      <span style={{ fontSize: 11, fontWeight: 700, color: C.textMuted, letterSpacing: "0.06em", textTransform: "uppercase", paddingTop: 2 }}>{label}</span>
                      <span style={{ fontSize: 15, color: C.text, lineHeight: 1.6 }}>{val}</span>
                    </div>
                  ))}
                </div>
                <div style={{ marginTop: 36, padding: 28, background: C.navy, borderRadius: 8 }}>
                  <p style={{ fontFamily: serif, fontSize: 19, fontStyle: "italic", color: C.white, lineHeight: 1.6, margin: "0 0 16px" }}>
                  ...
                  <p style={{ fontSize: 13, color: "rgba(255,255,255,0.4)", margin: 0 }}>Air Canada v. Jake Moffatt · 2024 · How this session opens</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section style={{ background: C.white, padding: "96px 24px", borderTop: `1px solid ${C.border}` }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div ref={s6.ref} style={{ opacity: s6.v ? 1 : 0, transform: s6.v ? "none" : "translateY(24px)", transition: "all 0.8s ease" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 56 }}>
              <div style={{ height: 1, flex: 1, background: C.border }} />
              <span style={{ fontSize: 11, fontWeight: 600, letterSpacing: "0.12em", textTransform: "uppercase", color: C.textMuted, whiteSpace: "nowrap" }}>The 90-Day Execution Plan</span>
              <div style={{ height: 1, flex: 1, background: C.border }} />
            </div>
            <h2 style={{ fontFamily: serif, fontSize: "clamp(28px,3.5vw,44px)", fontWeight: 700, letterSpacing: "-0.02em", color: C.navy, margin: "0 0 8px" }}>Not eighteen months. Ninety days.</h2>
            <p style={{ fontSize: 16, color: C.textSecond, margin: "0 0 48px" }}>"If anyone tells you this takes longer, what they are really telling you is that they don't want to move."</p>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 32 }}>
              {[
                ...
                <div key={phase} style={{ borderTop: `3px solid ${color}`, paddingTop: 24 }}>
                  <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color, marginBottom: 8 }}>{phase}</div>
                  <h3 style={{ fontFamily: serif, fontSize: 22, fontWeight: 700, color: C.navy, margin: "0 0 20px" }}>{title}</h3>
                  <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 12 }}>
                    {items.map((item, i) => (
                      <li key={i} style={{ display: "flex", gap: 10, fontSize: 14, color: C.textSecond, lineHeight: 1.5 }}>
      ...
      {/* ── PRICING (SINGLE TIER) ─────────────────────────── */}
      <section style={{ background: C.cream, padding: "96px 24px", borderTop: `1px solid ${C.border}` }} id="register">
        <div style={{ maxWidth: 640, margin: "0 auto" }}>
          <div ref={s7.ref} style={{ opacity: s7.v ? 1 : 0, transform: s7.v ? "none" : "translateY(24px)", transition: "all 0.8s ease" }}>
            <div style={{ textAlign: "center", marginBottom: 48 }}>
              <p style={{ fontSize: 11, fontWeight: 600, letterSpacing: "0.12em", textTransform: "uppercase", color: C.textMuted, marginBottom: 16 }}>Invitation-Only · Limited to 20 Seats</p>
              <h2 style={{ fontFamily: serif, fontSize: "clamp(32px,4vw,48px)", fontWeight: 700, letterSpacing: "-0.02em", color: C.navy, margin: "0 0 16px" }}>Secure your place before this cohort closes.</h2>
              <p style={{ fontSize: 17, color: C.textSecond, maxWidth: 440, margin: "0 auto 12px", lineHeight: 1.6 }}>
            ...
            <div style={{
              ...
              <div style={{ padding: 48 }}>
                <div style={{ marginBottom: 28 }}>
                  <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: C.goldLight, margin: "0 0 8px" }}>{cfg.label}</p>
                  <h3 style={{ fontFamily: serif, fontSize: 26, fontWeight: 700, color: tier === "executive" ? C.white : C.navy, margin: "0 0 4px" }}>{cfg.sub}</h3>
                  <p style={{ fontSize: 13, color: tier === "executive" ? "rgba(255,255,255,0.4)" : C.textMuted, marginBottom: 24 }}>{cfg.badge}</p>
                  <div>
                    <span style={{ fontFamily: serif, fontSize: 64, fontWeight: 700, color: tier === "executive" ? C.white : C.navy, lineHeight: 1 }}>${cfg.price}</span>
                    <span style={{ fontSize: 16, color: tier === "executive" ? "rgba(255,255,255,0.4)" : C.textMuted, marginLeft: 8 }}>/ seat</span>
                ...
                <ul style={{ listStyle: "none", padding: 0, margin: "0 0 36px", display: "flex", flexDirection: "column", gap: 14 }}>
                  {cfg.perks.map(item => (
                    <li key={item} style={{ display: "flex", gap: 12, fontSize: 15, color: tier === "executive" ? "rgba(255,255,255,0.8)" : C.textSecond, lineHeight: 1.4 }}>
                      <Check style={{ width: 16, height: 16, color: C.goldLight, flexShrink: 0, marginTop: 1 }} />{item}
                    </li>
                  ))}
                </ul>

                <button onClick={openReg}
                  style={{ display: "flex", width: "100%", alignItems: "center", justifyContent: "center", gap: 8, padding: "17px", background: C.goldLight, color: C.white, border: "none", borderRadius: 8, fontSize: 16, fontWeight: 700, fontFamily: sans, cursor: "pointer", boxSizing: "border-box" }}>
            ...
            <div style={{ marginTop: 20, padding: 18, background: C.white, borderRadius: 8, border: `1px solid ${C.border}`, textAlign: "center" }}>
              <p style={{ fontSize: 14, color: C.textSecond, margin: 0 }}>
      ...
      <section style={{ background: C.white, padding: "96px 24px", borderTop: `1px solid ${C.border}` }}>
        <div style={{ maxWidth: 720, margin: "0 auto" }}>
          <h2 style={{ fontFamily: serif, fontSize: "clamp(28px,3.5vw,40px)", fontWeight: 700, letterSpacing: "-0.02em", color: C.navy, margin: "0 0 48px", textAlign: "center" }}>Questions</h2>
          <div>
            {FAQS.map((faq, i) => (
              <div key={i} style={{ borderBottom: `1px solid ${C.border}` }}>
                <button onClick={() => setOpenFaq(openFaq === i ? null : i)}
                  ...
                  <span style={{ fontSize: 16, fontWeight: 600, color: C.navy, fontFamily: sans, lineHeight: 1.4 }}>{faq.q}</span>
                ...
                <div style={{ maxHeight: openFaq === i ? 240 : 0, overflow: "hidden", transition: "max-height 0.35s ease" }}>
                  <p style={{ fontSize: 15, color: C.textSecond, lineHeight: 1.7, paddingBottom: 24, margin: 0 }}>{faq.a}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section style={{ background: C.navy, padding: "96px 24px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 860, margin: "0 auto", textAlign: "center", position: "relative" }}>
          <p style={{ fontSize: 11, fontWeight: 600, letterSpacing: "0.12em", textTransform: "uppercase", color: C.goldLight, marginBottom: 32 }}>DBS Bank Singapore · 800+ AI models · Zero material incidents · $250M+ annual ROI</p>
          <h2 style={{ fontFamily: serif, fontSize: "clamp(32px,5vw,64px)", fontWeight: 700, lineHeight: 1.1, letterSpacing: "-0.02em", color: C.white, margin: "0 0 28px" }}>
          ...
          <p style={{ fontSize: 18, color: "rgba(255,255,255,0.55)", margin: "0 0 10px" }}>
            Now it is yours. <strong style={{ color: C.white }}>{seats.remaining} seats remain in this cohort.</strong>
          </p>
          <p style={{ fontSize: 13, color: "rgba(255,255,255,0.25)", margin: "0 0 48px" }}>23 May 2026 · Virtual · Live Online · 6:00 PM GST</p>
          <button onClick={openReg}
            style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "17px 40px", background: C.goldLight, color: C.white, border: "none", borderRadius: 6, fontSize: 16, fontWeight: 700, fontFamily: sans, cursor: "pointer" }}>
            Reserve {cfg.label} · ${cfg.price} <ArrowRight style={{ width: 17, height: 17 }} />
          </button>
          <p style={{ fontSize: 12, color: "rgba(255,255,255,0.2)", marginTop: 20, display: "flex", alignItems: "center", justifyContent: "center", gap: 5 }}>
      ...
      {/* ── FOOTER ────────────────────────────────────────── */}
      <footer style={{ background: C.cream, borderTop: `1px solid ${C.border}`, padding: "28px 24px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <a href="/" style={{ textDecoration: "none", fontFamily: serif, fontSize: 18, fontWeight: 700, color: C.navy }}>
              Forillon<span style={{ color: C.goldLight }}>Tech</span>
            </a>
            <span style={{ color: C.border }}>·</span>
            <span style={{ fontSize: 13, color: C.textMuted }}>The Agentic Shift · Session 1 · Virtual</span>
          </div>
          <div style={{ display: "flex", gap: 28 }}>
            {[{ l: "About Sharath", h: "/about" }, { l: "Solutions", h: "/solutions" }, { l: "Contact", h: "/contact" }, { l: "Privacy", h: "/privacy-policy" }, { l: "Terms", h: "/terms-of-service" }].map(({ l, h }) => (
              <a key={l} href={h} style={{ fontSize: 13, color: C.textMuted, textDecoration: "none" }}>{l}</a>
            ))}
          </div>
