...
import { Calendar, ArrowRight, Workflow, Cloud, Database, Users } from "lucide-react";
...
export default function DigitalTransformation() {
  const features = [
    ...
    },
    {
      ...
      description: "Migrate and optimize your infrastructure for the cloud era"
    },
    {
      icon: Database,
      title: "Data Integration",
      description: "Unify disparate systems and unlock data-driven insights"
    },
    {
      icon: Users,
      title: "Change Management",
      description: "Guide your team through successful digital adoption"
    }
  ];
      ...
      <section className="pt-32 pb-20 px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Modernize your business operations with comprehensive digital transformation 
            strategies that drive efficiency, innovation, and competitive advantage.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We guide organizations through every aspect of digital transformation, 
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <div className="bg-electric-teal rounded-2xl p-12 text-white">
            ...
            <p className="text-lg text-white/90 mb-8">
              Let's create a digital transformation roadmap tailored to your organization's needs.
            </p>
            <Button 
