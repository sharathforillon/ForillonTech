...
import { Calendar, ArrowRight, Brain, Target, Shield, Zap } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Comprehensive AI strategy development aligned with business objectives"
    },
    {
      icon: Target,
      title: "Use Case Identification",
      description: "Identify high-impact AI opportunities across your organization"
    },
    {
      icon: Shield,
      title: "Risk Assessment",
      description: "Evaluate and mitigate AI implementation risks and challenges"
    },
    {
      icon: Zap,
      title: "Implementation Roadmap",
      description: "Step-by-step guidance for successful AI transformation"
    }
  ];
      ...
      <section className="pt-32 pb-20 px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Transform your business with strategic AI implementation. Our expert consultants 
            help you identify opportunities, minimize risks, and accelerate innovation.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We provide comprehensive AI strategy consulting to help your organization 
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <div className="bg-electric-teal rounded-2xl p-12 text-white">
            ...
            <p className="text-lg text-white/90 mb-8">
              Let's discuss how our AI consulting expertise can transform your business operations.
            </p>
            <Button 
