    ...
    <footer className="bg-slate-gray text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-gray-600 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-300 text-sm">© 2024 Forillon Technologies. All rights reserved.</p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="#" className="text-gray-300 hover:text-electric-teal text-sm transition-colors">Privacy Policy</a>
            <a href="#" className="text-gray-300 hover:text-electric-teal text-sm transition-colors">Terms of Service</a>
            <a href="#" className="text-gray-300 hover:text-electric-teal text-sm transition-colors">Cookie Policy</a>
          </div>
        </div>
      </div>
    </footer>
