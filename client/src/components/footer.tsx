        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-gray-200 rounded-lg flex items-center justify-center hover:bg-electric-teal hover:text-white transition-colors text-gray-600">
          ...
          <div>
            <h4 className="text-lg font-semibold mb-4 text-forillon-navy">Services</h4>
          ...
          <div>
            <h4 className="text-lg font-semibold mb-4 text-forillon-navy">Company</h4>
            <ul className="space-y-2 text-gray-600">
