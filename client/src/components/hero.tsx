...
export default function Hero() {
  ...
  return (
    <section className="relative bg-gradient-to-br from-forillon-navy via-forillon-navy to-slate-gray py-20 lg:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-forillon-navy/50 to-transparent"></div>
