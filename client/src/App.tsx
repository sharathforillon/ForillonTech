...
import AIReadiness from "@/pages/solutions/ai-readiness";
...
import AgenticShiftPage from "@/pages/agentic-shift";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/solutions/ai-readiness" component={AIReadiness} />
      ...
      <Route path="/agentic-shift">{() => <AgenticShiftPage />}</Route>
      <Route path="/agentic-shift/executive">{() => <AgenticShiftPage tier="executive" />}</Route>
      <Route path="/agentic-shift/leadership">{() => <AgenticShiftPage tier="leadership" />}</Route>
